...
- PENDING: user to add a Tavily key (https://app.tavily.com, free tier) to backend/.env TAVILY_API_KEY — no code changes needed; live research switches on after a backend restart.
